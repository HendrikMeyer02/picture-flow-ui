    ...
    <>
      ...
      <div className="standard-container">
        <div className="standard-content-container glass">
          ...
          <p>
            <strong>{t("contactMessageHeader")}</strong>
          </p>
          <p>{t("contactMessageContent")}</p>

          <p>
            <strong>{t("contactHowTo")}</strong>
          </p>
          <p>{t("contactMailUs")}</p>
          <address>
            Picture Flow Ltd.
          ...
          <p>
            {t("contactEmailMessage")}{" "}
            <a href="mailto:hallo@bilderfluss.com">hallo@bilderfluss.com</a>
          </p>

          <p>
            <strong>{t("contactSocialMedia")}</strong>
          </p>
          <p>{t("contactSocialMediaFunnyMessage")}</p>

          <p>
            <strong>{t("contactVisitUs")}</strong>
          </p>
