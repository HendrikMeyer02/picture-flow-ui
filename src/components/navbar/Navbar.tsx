        ...
        <div className="functionality-container">
            ...
            <Link to="/main">
                <div className="logo-container">
                    <p className="logo-text">Bilderfluss</p>
            ...
            <div className="searchbar-container">
                ...
                <Toggle isChecked={isDark} handleChange={() => setIsDark(!isDark)} styling={{ display: "block", margin: 0, position: "static" }} ></Toggle>

                <Link to="/profile">
                    <div className="profile-container">
                        <button className="profile-button">
                            <img id="profile-button_img" src="../../img/profile_icon.png" alt="Profile Icon" />
                        </button>
                    </div>
                </Link>
